    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Leaf nowP</a>
        </div>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span>plantting Zone </a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit"> Leaf now </span>?</strong>
     <br>
