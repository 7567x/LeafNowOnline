...
<div class="jumbotron">
  <div class="container text-center">
    ...
    <!--p>Plant me today i will save  you tomorrow</p-->
  </div>
</div>
...
<!-- Display all item from food table -->
<?php
...
else
{
  ...
  <div class="container">
    <div class="jumbotron">
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Oops! it is Not available.</h1> </label>
        <p>Stay Safe..! :P</p>
      </center>
