...
<div class="container">
    <div class="jumbotron">
     <h1>Hello Admin! </h1>
     <p>Manage all your Bakery from here</p>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item ">My plant</a>
    		<a href="view_food_items.php" class="list-group-item ">View Items</a>
    		<a href="add_food_items.php" class="list-group-item ">Add  Items</a>
    		<a href="edit_food_items.php" class="list-group-item active">Edit  Items</a>
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> EDIT YOUR ITEMS HERE </h3>
